...
walletBalanceEntityFromJson(WalletBalanceEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
		data.status = json['status'];
	}
	if (json['user'] != null) {
		data.user = WalletBalanceUser().fromJson(json['user']);
	}
	return data;
}
...
walletBalanceUserFromJson(WalletBalanceUser data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['userCoins'] != null) {
		data.userCoins = (json['userCoins'] as List).map((v) => WalletBalanceUserUserCoins().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> walletBalanceUserToJson(WalletBalanceUser entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
walletBalanceUserUserCoinsFromJson(WalletBalanceUserUserCoins data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['userId'] != null) {
	...
	if (json['coinTypes'] != null) {
		data.coinTypes = WalletBalanceUserUserCoinsCoinTypes().fromJson(json['coinTypes']);
	}
	return data;
}

Map<String, dynamic> walletBalanceUserUserCoinsToJson(WalletBalanceUserUserCoins entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
walletBalanceUserUserCoinsCoinTypesFromJson(WalletBalanceUserUserCoinsCoinTypes data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> walletBalanceUserUserCoinsCoinTypesToJson(WalletBalanceUserUserCoinsCoinTypes entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['name'] = entity.name;
