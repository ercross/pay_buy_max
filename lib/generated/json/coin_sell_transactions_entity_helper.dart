...
coinSellTransactionsEntityFromJson(CoinSellTransactionsEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
		data.status = json['status'];
	}
	if (json['transactions'] != null) {
		data.transactions = (json['transactions'] as List).map((v) => CoinSellTransactionsTransactions().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> coinSellTransactionsEntityToJson(CoinSellTransactionsEntity entity) {
...
coinSellTransactionsTransactionsFromJson(CoinSellTransactionsTransactions data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['sellBy'] != null) {
		data.sellBy = json['sellBy'].toString();
	}
	...
	if (json['coin'] != null) {
		data.coin = CoinSellTransactionsTransactionsCoin().fromJson(json['coin']);
	}
	if (json['user'] != null) {
		data.user = CoinSellTransactionsTransactionsUser().fromJson(json['user']);
	}
	return data;
}

Map<String, dynamic> coinSellTransactionsTransactionsToJson(CoinSellTransactionsTransactions entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
coinSellTransactionsTransactionsCoinFromJson(CoinSellTransactionsTransactionsCoin data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> coinSellTransactionsTransactionsCoinToJson(CoinSellTransactionsTransactionsCoin entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
coinSellTransactionsTransactionsUserFromJson(CoinSellTransactionsTransactionsUser data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> coinSellTransactionsTransactionsUserToJson(CoinSellTransactionsTransactionsUser entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['name'] = entity.name;
