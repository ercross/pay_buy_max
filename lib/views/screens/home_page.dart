...
class _HomeState extends State<_HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(
        SystemUiOverlayStyle(systemNavigationBarColor: Color(0xFFC9782F)));
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                    "NGN " + args.user!.wallet.toString(),
                                    style: TextStyle(color: Color(0xFFC9782F),
                                        fontSize: 40,
                                        fontWeight: FontWeight.bold),
                                    textAlign: TextAlign.center),
                              )
                      ...
                      child: Wrap(
                        ...
                        children: [
                          ElevatedButton(
                            ...
                            child: Text('NGN', style: TextStyle(
                                color: Colors.black,
                                fontSize: 18,
                                fontWeight: FontWeight.bold)),
                          )
                      ...
                      child: Wrap(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text('NGN 55,000', style: TextStyle(
                                  color: Colors.black, fontSize: 18),
                                  textAlign: TextAlign.start),
                              Text('+ 10.1%', style: TextStyle(
